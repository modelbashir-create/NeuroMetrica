<p align="center">
  <img src="../regularicon.png" alt="NeuroMetrica app icon" width="120" />
</p>
...
Roadmap (V1-V5, aligned with Vertical Slices)
...
- [ ] Additional research formats or specialized tools not in the version buckets yet
